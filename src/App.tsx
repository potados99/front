  ...
  const sites: HostProps[] = [
    {
      ...
      links: [{ label: "바로가기", url: "https://blog.potados.com" }],
    },
    {
      title: "병준이의 군대 여행",
      ...
      protocols: ["http"],
      description:
        "군대로 여행을 떠난 병준이의 이야기가 올라옵니다. 남은 날짜, 다가오는 일정을 볼 수 있어요. 댓글 달아주세요!",
      links: [{ label: "바로가기", url: "https://duty.potados.com" }],
    },
    {
      title: "클라우드 저장소",
      ...
      links: [{ label: "바로가기", url: "https://cloud.potados.com" }],
    },
    {
      title: "텍스트 수집기",
      ...
      protocols: ["http"],
      description:
        "텍스트 업로드와 삭제를 지원하는 간단한 웹 메모장입니다. API 사용하여 간단한 임시 로그 수집기로 사용할 수 있어요.",
      links: [{ label: "바로가기", url: "https://collect.potados.com" }],
    },
    {
      title: "툴박스",
      ...
      links: [{ label: "바로가기", url: "https://tools.potados.com" }],
    },
    {
      title: "수강신청 클라이언트",
      ...
      links: [{ label: "바로가기", url: "http://sugang.potados.com" }],
    },
    {
      title: "인스턴트 채팅",
      ...
      links: [{ label: "바로가기", url: "https://chat.potados.com" }],
    },
    {
      title: "GitHub 감자도스 봇",
      ...
      links: [{ label: "바로가기", url: "https://bot.potados.com" }],
    },
    {
      title: "프론트 페이지",
      ...
      links: [{ label: "바로가기", url: "https://www.potados.com" }],
    },

    {
      ...
      links: [{ label: "바로가기", url: "https://shell.potados.com" }],
    },
    {
      ...
      links: [{ label: "바로가기", url: "https://desktop.potados.com" }],
    },
    {
      title: "원격 브라우저",
      ...
      links: [{ label: "바로가기", url: "https://browser.potados.com" }],
    },

    {
      ...
      links: [{ label: "바로가기", url: "ssh://potados@aws.potados.com" }],
    },
    {
      title: "홈 네트워크 엔트리",
      ...
      links: [{ label: "바로가기", url: "https://home.potados.com" }],
    },

    {
      ...
      links: [{ label: "바로가기", url: "https://flick.potados.com" }],
    },
    {
      title: "집중 타이머",
      ...
      links: [{ label: "바로가기", url: "https://focus.potados.com" }],
    },
  ];

  return (
    <Container className={"col-12"}>
      <Row className={"col-md-6 mx-auto"}>
        {sites.map((s) => (
